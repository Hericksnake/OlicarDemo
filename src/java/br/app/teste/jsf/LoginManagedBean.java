...
import br.app.teste.service.AuditoriaService;
import br.app.teste.service.I18nService;
import br.app.teste.service.MailService;
...
public class LoginManagedBean implements Serializable {
    ...
    public void cadastrar() {
        pessoa.setPassword(Service.getInstance().encryptPassword(password));
        PapelBean papel = SecurityService.getInstance().buscaPapelCadastro();
        if (papel != null) {
