 ...
 */
package br.app.teste.security.service;
...
import br.app.teste.security.daos.ObjetoProtegidoJpaDao;
import br.app.teste.security.daos.PapelJpaDao;
...
public class SecurityService {
    ...
    public PapelBean buscaPapelCadastro(){
        List<PapelBean> listaPapeis = listarPapeis();
        for(PapelBean p: listaPapeis){
